...
class Ray_On_AML():
    ...
    exp_name ='ray_on_aml', maxnode =5, additional_conda_packages=[],additional_pip_packages=[], job_timeout=600000, master_ip_env_name="AZ_BATCHAI_JOB_MASTER_NODE_IP", world_rank_env_name="AZUREML_CR_NODE_RANK"):
